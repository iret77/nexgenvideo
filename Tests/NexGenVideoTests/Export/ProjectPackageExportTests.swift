...
@Suite("NexGenVideo project export (collect media)")
struct ProjectPackageExportTests {
    ...
    private func makeFixture() throws -> (root: URL, source: URL, dest: URL, externalContents: String) {
        ...
        let source = root.appendingPathComponent("Source.ngv", isDirectory: true)
        ...
        return (root, source, root.appendingPathComponent("Packaged.ngv", isDirectory: true), externalContents)
    }
