...
ENGINE_BOUNDARY_VALUE_LAYOUTS = {
    ...
    "FramesManifest": {
        "path": "Engine/Sources/NexGenEngine/Artifacts/FramesManifest.swift",
        "start": "public struct FramesManifest: Codable, Sendable, Equatable {",
        "end": "    public init(",
        "members": [
            "var schema: String", "var project: String", "var generated: String",
            "var approvalMode: String", "var shots: [ShotFrames]",
        ],
    },
    "ShotFrames": {
        "path": "Engine/Sources/NexGenEngine/Artifacts/FramesManifest.swift",
        "start": "public struct ShotFrames: Codable, Sendable, Equatable {",
        "end": "    public init(",
        "members": [
            "var shotId: String", "var keyframeStrategy: String",
            "var frames: [FrameEntry]",
        ],
    },
    "FrameEntry": {
        "path": "Engine/Sources/NexGenEngine/Artifacts/FramesManifest.swift",
        "start": "public struct FrameEntry: Codable, Sendable, Equatable {",
        "end": "    public init(",
        "members": [
            "var role: String", "var path: String", "var prompt: String",
            "var runwayModel: String", "var approved: Bool",
            "var providerPrompt: String", "var multiRefHints: [String]",
        ],
    },
    "RenderEntry": {
        "path": "Engine/Sources/NexGenEngine/Artifacts/RenderManifest.swift",
        "start": "public struct RenderEntry: Codable, Sendable, Equatable {",
        "end": "    public init(",
        "members": [
            "var shotId: String", "var phase: String", "var status: RenderStatus",
            "var output: String?", "var costEur: Double", "var updatedAt: String?",
            "var lastFramePath: String?", "var startFramePath: String?",
            "var referencePaths: [String]?",
        ],
    },
    "RenderManifest": {
        "path": "Engine/Sources/NexGenEngine/Artifacts/RenderManifest.swift",
        "start": "public struct RenderManifest: Sendable, Equatable {",
        "end": "    public init(",
        "members": [
            "var project: String", "var phase: String", "var schema_: String",
            "var entries: [String: RenderEntry]",
        ],
    },
    "RenderInputProof": {
        "path": "Engine/Sources/NexGenEngine/Artifacts/RenderProof.swift",
        "start": "public struct RenderInputProof: Codable, Sendable, Equatable {",
        "end": "    public init(",
        "members": ["let path: String", "let sha256: String"],
    },
    "RenderProofEntry": {
        "path": "Engine/Sources/NexGenEngine/Artifacts/RenderProof.swift",
        "start": "public struct RenderProofEntry: Codable, Sendable, Equatable {",
        "end": "    private enum CodingKeys:",
        "members": [
            "let shotId: String", "let output: String", "let outputSha256: String",
            "let providerPrompt: String", "let generationModel: String",
            "let sourceVideo: RenderInputProof?", "let startFrame: RenderInputProof?",
            "let endFrame: RenderInputProof?", "let referenceImages: [RenderInputProof]",
            "let referenceVideos: [RenderInputProof]", "let referenceAudio: [RenderInputProof]",
        ],
    },
    "RenderProofManifest": {
        "path": "Engine/Sources/NexGenEngine/Artifacts/RenderProof.swift",
        "start": "public struct RenderProofManifest: Codable, Sendable, Equatable {",
        "end": "    public init(",
        "members": [
            "let schema: String", "let project: String", "let phase: String",
            "var entries: [String: RenderProofEntry]",
        ],
    },
    "Brief": {
        "path": "Engine/Sources/NexGenEngine/Artifacts/Brief.swift",
        "start": "public struct Brief: Codable, Sendable, Equatable {",
        "end": "    private enum CodingKeys:",
        "members": [
            "var schema: String", "var project: String", "var generated: String",
            "var generator: String", "var mission: Mission", "var missionOther: String?",
            "var targetPlatform: String", "var targetAudience: String?",
            "var aspectRatio: AspectRatio", "var aspectRatioOther: String?",
            "var lengthMode: String", "var projectMode: String",
            "var modelPreference: ModelPreference", "var modelPreferenceOther: String?",
            "var frameImageModel: FrameImageModel", "var frameImageModelOther: String?",
            "var bibleImageModel: FrameImageModel?", "var compositeImageModel: FrameImageModel?",
            "var budgetEur: Double", "var budgetStopEur: Double?",
            "var conceptType: ConceptType", "var conceptTypeOther: String?",
            "var visualMedium: VisualMedium", "var visualMediumOther: String?",
            "var visualMediumNotes: String?", "var tone: [ToneTag]",
            "var toneOther: String?", "var styleReferences: [String]",
            "var figures: FigurePresence", "var figuresOther: String?",
            "var figureCountHint: String?", "var lyricsIntegration: LyricsIntegration",
            "var lyricsIntegrationOther: String?", "var enableChordAnalysis: Bool",
            "var stemsProvider: StemsProvider", "var finalResolution: VideoResolution",
            "var previewMode: PreviewMode", "var cutHandlesMode: CutHandlesMode",
            "var directorPattern: String?", "var allowGenreCrossPatterns: Bool",
            "var allowTextOverlays: Bool", "var notes: String?",
        ],
    },
    "Bible": {
        "path": "Engine/Sources/NexGenEngine/Artifacts/Bible.swift",
        "start": "public struct Bible: Codable, Sendable, Equatable {",
        "end": "    private enum CodingKeys:",
        "members": [
            "var schema: String", "var project: String", "var generated: String",
            "var generator: String", "var look: LookGuide", "var characters: [Character]",
            "var ensembles: [Ensemble]", "var props: [Prop]",
            "var locations: [Location]", "var notes: String?",
        ],
    },
}
