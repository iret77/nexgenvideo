...
Für Animation: vollständige Medium-/Bewegungssignaturen und siebenlagiger Master Style Block aus Style Control §6c; Stills tragen eine budgetierte Kondensation, keine Video-Motion-Schicht. Für Commercial/Social: Performance-Capture/Re-skin mit Quellen-Lineage, separat geroutete Text-/Motion-Design-Ausgabe, Loop-Blockout und echte Reframe-Prüfung. Für Documentary/Explainer: Sprecher-Quellclip, Voice-Reference/Voice-Profile und Audio-/Bildanteile getrennt zuordnen; reales Zeugnis bleibt quellengebunden. Fiction/Series übernehmen Animatic und technique-aware Blueprint-Synthese. Trailer/Vacation bleiben als NGV-Designableitungen markiert; die Quelle macht daraus keine neu belegten vollständigen Pack-Workflows.

# Future Format Packs — Knowledge & Behavior Spec v0.2
...
Quelle: der bereitgestellte Skill v3.4; Archiv-SHA256 in `../inventory.json`. Referenzkürzel unten beziehen sich auf die vollständig lokal extrahierten Kapitel in `../handbook/`. Die erste Spec entstand aus 3.1.1; diese Revision übernimmt dessen weiterhin gültiges Packdesign und die unten genannten 3.4-Deltas.
