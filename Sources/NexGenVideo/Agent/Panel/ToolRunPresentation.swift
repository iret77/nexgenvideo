...
enum ToolRunPresentation {
    ...
    private static let labels: [String: String] = [
        ...
        "write_analysis_interpretation": "Saving analysis interpretation",
        "write_brief": "Saving the brief",
        "write_production_design": "Saving production design",
        "write_treatment": "Saving the treatment",
        "write_storyboard": "Saving the storyboard",
        "write_bible": "Saving the Bible",
        "write_shotlist": "Saving the shot list",
        "write_phase_extension": "Saving phase work",
        ...
        "copy_project_file": "Checking a project reference",
        "prepare_generation_batch": "Preparing a generation batch",
        "get_generation_batches": "Reading generation batches",
