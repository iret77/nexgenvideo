...
/// background). Used by the Inspector's clip/asset tabs and the Project cockpit's panel tabs — one
/// component, one behavior, rendered wherever sub-tabs are needed (docs/UI_UX_CONCEPT.md §2.1).
